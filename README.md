...
| 15 октября  |  07   | <ul><li>Проектирование кода</li><li>Шаблоны проектирования</li></ul>                                | ＼(٥⁀▽⁀ )／                             | [Контест 4: Декораторы, итераторы, классы](https://contest.yandex.ru/contest/83412)                                    |
...
|  26 ноября  |  13   | <ul><li>Асинхронное программирование. `aiogram` </li></ul>                                          | ＼(٥⁀▽⁀ )／                             | ＼(٥⁀▽⁀ )／                                                                     |
| 03 декабря  |  14   | <ul><li>Ctypes</li></ul>                                                                            | ＼(٥⁀▽⁀ )／                             | ＼(٥⁀▽⁀ )／                                                                     |
| 10 декабря  |  15   | <ul><li>Методы повышения эффективности</li></ul>                                                    | ＼(٥⁀▽⁀ )／                             | ＼(٥⁀▽⁀ )／                                                                     |
