...
| 24 сентября |  04   | <ul><li>Введение в обработку изображений</li><li>Обсуждения задания 1 на KNN</li></ul>              | ＼(٥⁀▽⁀ )／                             | [Задание 1: Метрические алгоритмы классификации](https://github.com/mmp-practicum-team/mmp_practicum_fall_2025/tree/main/Tasks/Task-01)                              |
