# Курс "Практикум на ЭВМ 2025/2026" для бакалавров 3 курса кафедры ММП ВМК МГУ, осенний семестр

Этот репозиторий содержит материалы к курсу "Практикум на ЭВМ", читаемому бакалаврам 3 курса кафедры ММП факультета ВМК МГУ в осеннем семестре 2025 года.
...
- Курс читается в поддержку курса "Математические методы распознавания образов" (машинное обучение, часть 1), читаемого на кафедре ММП:
  - [Курс семинаров по машинному обучению](https://github.com/mmp-mmro-team/mmp_mmro_fall_2025);
  - [Курс лекций по машинному обучению](http://www.machinelearning.ru/wiki/index.php?title=%D0%9C%D0%B0%D1%82%D0%B5%D0%BC%D0%B0%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B5_%D0%BC%D0%B5%D1%82%D0%BE%D0%B4%D1%8B_%D1%80%D0%B0%D1%81%D0%BF%D0%BE%D0%B7%D0%BD%D0%B0%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F_%D0%BE%D0%B1%D1%80%D0%B0%D0%B7%D0%BE%D0%B2_%28%D0%BA%D1%83%D1%80%D1%81_%D0%BB%D0%B5%D0%BA%D1%86%D0%B8%D0%B9%2C_%D0%92.%D0%92.%D0%9A%D0%B8%D1%82%D0%BE%D0%B2%29).

## Материалы

- Видеозаписи практикума 2023/2024 года можно посмотреть [в этом плейлисте](https://www.youtube.com/playlist?list=PLVF5PzSHILHQyxuWHZEN-kBdgj6Ixd1bQ);
...
- Материалы 2024/2025 года можно посмотреть [в этом репозитории](https://github.com/mmp-practicum-team/mmp_practicum_fall_2024);
- Материалы 2023/2024 года можно посмотреть [в этом репозитории](https://github.com/mmp-practicum-team/mmp_practicum_fall_2023);
- Материалы 2022/2023 года можно посмотреть [в этом репозитории](https://github.com/mmp-practicum-team/mmp_practicum_fall_2022);
...
- Большие практические задания [выкладываются здесь](https://github.com/mmp-practicum-team/mmp_practicum_fall_2025/tree/master/Tasks).

- Все задания сдаются в системе [anytask](https://anytask.org/course/1201).

## Занятия

|    Дата     | Номер | Тема                                                                                                | Материалы                               | ДЗ                                                                              |
| :---------: | :---: | --------------------------------------------------------------------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------------- |
| 03 сентября |  01   | <ul><li>Введение в Python</li></ul>                                                                 | [Введение в Python](Seminars/01-intro/) | [Контест 1: Введение в язык Python](https://contest.yandex.ru/contest/80963)                                           |
| 10 сентября |  02   | <ul><li>Организация кода в Python: функции, модули, классы</li><li>Итераторы и генераторы</li></ul> | [Организация кода Python](Seminars/02-python_tools) | [Контест 2: Классы, генераторы](https://contest.yandex.ru/contest/81304)                                               |
| 17 сентября |  03   | <ul><li>Библиотека numpy и матрично-векторные вычисления</li></ul>                                  | [Numpy](Seminars/03-numpy/)                             | [Контест 3: Векторизация вычислений с помощью библиотеки Numpy](https://contest.yandex.ru/contest/81645)               |
| 24 сентября |  04   | <ul><li>Введение в обработку изображений</li><li>Обсуждения задания 1 на KNN</li></ul>              | [KNN и введение в обработку изображений](Seminars/04-knn_and_cv/)                             | [Задание 1: Метрические алгоритмы классификации](Tasks/Task-01)                              |
| 01 октября  |  05   | <ul><li>Подготовка отчётов</li><li>Система TeX</li></ul>                                            | [Подготовка отчётов, $LaTeX$](Seminars/05-reports) | ＼(٥⁀▽⁀ )／                                                                     |
| 08 октября  |  06   | <ul><li>Основы ООП</li><li>Декораторы</li><li>Исключения</li><li>typing</li></ul>                   | [Парадигма ООП, классы в Python, декораторы в Python](Seminars/06-classes/)                             | ＼(٥⁀▽⁀ )／                                                                     |
| 15 октября  |  07   | <ul><li>Проектирование кода</li><li>Шаблоны проектирования</li></ul>                                | [Проектирование кода](./Seminars/7-oop/)                             | [Контест 4: Декораторы, итераторы, классы](https://contest.yandex.ru/contest/83412)                                    |
| 22 октября  |  08   | <ul><li>Введение в обработку текстов</li><li>Обсуждение задания 2 на лог. рег.</li></ul>            | ＼(٥⁀▽⁀ )／                             | [Задание 2: Градиентные методы обучения линейных моделей](Tasks/Task-02)                     |
| 29 октября  |  09   | <ul><li>Инструменты разработчика (часть 1)</li><li>VM, SSH, GIT</li><liGitFlow</li></ul>            | [Инструменты разработчика (часть 1)](Seminars/09-dev_tools/)                            | ＼(٥⁀▽⁀ )／                                                                     |
|  05 ноября  |  10   | <ul><li>Инструменты разработчика (часть 2)</li><li>Виртуальные окружения и контейнеры</li></ul>     | [Инструменты разработчика (часть 2)](Seminars/10-environments/)                             | ＼(٥⁀▽⁀ )／                                                                     |
|  12 ноября  |  11   | <ul><li>Основы веб-разработки (введение)</li></ul>                                                  | [Введение в web](Seminars/11-intro-web)                            | ＼(٥⁀▽⁀ )／                                                                     |
|  19 ноября  |  12   | <ul><li>Создание приложений с помощью FastAPI + Streamlit</li></ul>                                 | ＼(٥⁀▽⁀ )／                             | [Задание 3: Ансамбли алгоритмов для решения задачи регрессии. Веб-приложение]() |
| 26 ноября |  13   | <ul><li>Ctypes</li></ul>                                                                            | [Ctypes](./Seminars/13-ctypes)                             | ＼(٥⁀▽⁀ )／                                                                     |
| 03 декабря |  14   | <ul><li>Асинхронное программирование. </li></ul>                                          | ＼(٥⁀▽⁀ )／                             | ＼(٥⁀▽⁀ )／                                                                     |
| 10 декабря  |  15   | <ul><li>Методы повышения эффективности</li></ul>                                                    | [Параллельные выичсления](./Seminars/15-parallel)                             | ＼(٥⁀▽⁀ )／                                                                     |
...
4. Критерии итоговой оценки:
   - **отлично ≥ 180 баллов**, 3 практических задания зачтены
   - **хорошо ≥ 135 баллов**, 2 практических задания зачтены
...
* Штраф за основную часть будет реализован по следующей шкале: 1 день просрочки **-1 балла**, 2 дня просрочки **-2 баллов**, 3 дня просрочки **-4 баллов**, 4 дня просрочки **-7 баллов**, 5 дней просрочки **-10 баллов**, 6 дней просрочки **-13 баллов**, 7 дней просрочки **-16 баллов**. Далее - жесткий дедлайн.
