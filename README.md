...
| :---------: | :---: | --------------------------------------------------------------------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------------- |
| 03 сентября |  01   | <ul><li>Введение в Python</li></ul>                                                                 | [Введение в Python](Seminars/01-intro/) | [Контест 1: Введение в язык Python]()                                           |
| 10 сентября |  02   | <ul><li>Организация кода в Python: функции, модули, классы</li><li>Итераторы и генераторы</li></ul> | [Организация кода Python](Seminars/02-python_tools) | [Контест 2: Классы, генераторы]()                                               |
| 17 сентября |  03   | <ul><li>Библиотека numpy и матрично-векторные вычисления</li></ul>                                  | [Numpy](Seminars/03-numpy/)                             | [Контест 3: Векторизация вычислений с помощью библиотеки Numpy]()               |
| 24 сентября |  04   | <ul><li>Введение в обработку изображений</li><li>Обсуждения задания 1 на KNN</li></ul>              | [KNN и введение в обработку изображений](Seminars/04-knn_and_cv/)                             | [Задание 1: Метрические алгоритмы классификации](https://github.com/mmp-practicum-team/mmp_practicum_fall_2025/tree/main/Tasks/Task-01)                              |
...
| 15 октября  |  07   | <ul><li>Проектирование кода</li><li>Шаблоны проектирования</li></ul>                                | ＼(٥⁀▽⁀ )／                             | [Контест 4: Декораторы, итераторы, классы]()                                    |
| 22 октября  |  08   | <ul><li>Введение в обработку текстов</li><li>Обсуждение задания 2 на лог. рег.</li></ul>            | ＼(٥⁀▽⁀ )／                             | [Задание 2: Градиентные методы обучения линейных моделей]()                     |
